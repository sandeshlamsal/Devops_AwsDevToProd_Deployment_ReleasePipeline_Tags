...
# KMS key for flow log encryption (CKV_AWS_158)
resource "aws_kms_key" "flow_log" {
  description             = "KMS key for VPC flow log encryption — ${var.environment}"
...
# 1-year retention (CKV_AWS_338) + KMS encryption (CKV_AWS_158)
